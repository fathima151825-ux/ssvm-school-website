...
const MSG91_SENDER_ID = process.env.MSG91_SENDER_ID || 'SSVM';
...
export async function POST(request: NextRequest) {
  try {
    ...
    const { title, message, recipients } = body;
    ...
    // MSG91 Flow API payload — send in batches of 100
    ...
    console.error('MSG91 SMS API error:', error);
    return NextResponse.json(
